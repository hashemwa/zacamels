...
function calculateZakahAmount(numCamels) {
    ...
    if (numCamels < 5) {
        ...
        zakahResult = `2 ${camelLookup[3]} and ${Math.floor((numCamels - 120) / 5)} Sheep/Goats`;
        ...
        zakahResult = `3 ${camelLookup[3]} and ${Math.floor((numCamels - 150) / 5)} Sheep/Goats`;
...
function toggleArrowAndKey() {
    ...
    if (arrowRotated) {
        ...
        arrowRotated = false;
        key.style.transform = 'translateY(-350px)';
      } else {
